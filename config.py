DELAY = (10, 20)          # Диапазон рандомной задержки между задачами
WAL_AMOUNT_FOR_STAKE = 1  # Кол-во WAL токенов для стейкинга каждому валидатору (минимум 1)
MAX_VALIDATORS = 5        # Количество валидаторов для стейкинга одного аккаунта за один запуск софта (максимум 25)
MAX_CONCURRENT_TASKS = 5  # Одновременно выполняемых аккаунтов
